...
zip)
  ...
  mv "${TEMP_DIR}/mongodb-database-tools-${os_alias}-${arch_alias}-${version}" "${TEMP_DIR}/mongotools"
  ;;
esac

mv "${TEMP_DIR}/mongotools/bin/bsondump" "${BIN_DIR}/bsondump-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongodump" "${BIN_DIR}/mongodump-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongoexport" "${BIN_DIR}/mongoexport-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongofiles" "${BIN_DIR}/mongofiles-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongoimport" "${BIN_DIR}/mongoimport-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongorestore" "${BIN_DIR}/mongorestore-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongostat" "${BIN_DIR}/mongostat-${version}-${os}-${arch}"
mv "${TEMP_DIR}/mongotools/bin/mongotop" "${BIN_DIR}/mongotop-${version}-${os}-${arch}"
